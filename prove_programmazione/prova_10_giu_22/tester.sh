...
esegui_tutti_test ()
{
    ...
    esegui_test "stampa senza reinizializzazione" "" "3 7" 0
    ...
    esegui_test "reinizializzazione a dimensione uno, con stampa" "" "1 1 3 7" 1 "o"


    # reinizializzazione a molti elementi
    esegui_test "reinizializzazione a dimensione maggiore di uno" "" "1 2 3 7" 2 "oo" "oo"

    esegui_test "reinizializzazione a dimensione maggiore di uno" "" "1 3 3 7" 3 "ooo" "ooo" "ooo"
    ...
    esegui_test "doppia reinizializzazione con seconda a vuoto" "" "1 3 3 1 0 7" 0

    # doppia reinizializzazione con seconda a un elemento
    esegui_test "doppia reinizializzazione con seconda a un elemento" "" "1 3 1 1 3 7" 1 "o"


    # doppia reinizializzazione con seconda a stesso numero di elementi
    esegui_test "reinizializzazione a dimensione maggiore di uno" "" "1 3 1 3 3 7" 3 "ooo" "ooo" "ooo"

    # doppia reinizializzazione con prima a vuoto e seconda a molti elementi
    esegui_test "reinizializzazione a dimensione maggiore di uno" "" "1 0 1 3 3 7" 3 "ooo" "ooo" "ooo"
    ...
    esegui_test "aggiornamento di un oggetto" "" "1 3 2 1 1 1 3 7" 3 "ooo" "o-o" "ooo"
    esegui_test "aggiornamento di un oggetto in matrice vuota" "" "1 0 2 1 1 1 3 7" 0

    # aggiornamento di un oggetto in insieme prima vuoto e poi non vuoto
    # il secondo inserimento permette poi di controllare la stampa, e quindi
    # di controllare implicitamente se il primo inserimento ha provocato un
    # fallimento del programma

    esegui_test "aggiornamento di un oggetto in matrice prima vuota poi non vuota" "" "1 0 2 1 1 1 1 3 2 2 2 2 3 7" 3 "ooo" "ooo" "oo+"

    # "inserimento un elemento con stampa"
    # inserimento di due oggetti
    esegui_test "aggiornamento di due oggetti" "" "1 3 2 1 1 1 2 3 0 0 3 7" 3 "*oo" "o-o" "ooo"

    # aggiornamento di un oggetto con una stringa troppo lunga

    esegui_test "aggiornamento di un oggetto non presente" "" "1 2 2 1 2 0 3 7" 2 "oo" "oo"
    ...
    esegui_test "aggiornamento di un oggetto con un valore troppo grande" "" "1 2 2 4 1 1 3 7" 2 "oo" "oo"

    # inserimento di un oggetto sovrapposto
    esegui_test "doppio aggiornamento di un oggetto" "" "1 2 2 1 1 1 2 2 1 1 3 7" 2 "oo" "o*"
    ...
    # "salvataggio"
    esegui_test "salvataggio" 4 "1 3 2 3 1 1 4 3 7" 3 "ooo" "o*o" "ooo"

    # "salvataggio e aggiunta di un elemento"

    esegui_test "salvataggio e aggiornamento di un elemento" 4 "1 3 2 3 1 1 4 2 2 0 0 3 7" 3 "+oo" "o*o" "ooo"

    # "salvataggio e reinizializzazione a stesso numero di elementi"
    esegui_test "salvataggio" 4 "1 3 2 3 1 1 4 1 3 3 7" 3 "ooo" "ooo" "ooo"

    # "salvataggio, aggiunta di un elemento e nuovo salvataggio"
    esegui_test "salvataggio, aggiornamento di un elemento e nuovo salvataggio" 4 "1 3 2 3 1 1 4 2 2 0 0 4 3 7" 3 "+oo" "o*o" "ooo"


    # "caricamento"

    esegui_test "preparazione caricamento matrice vuota" 5 "4 3 7" 0
    esegui_test "caricamento matrice vuota" 5 "5 7" 0


    esegui_test "salvataggio per preparazione prossimi test" 5 "1 3 2 3 1 1 2 2 0 0 4 3 7" 3 "+oo" "o*o" "ooo"

    esegui_test "caricamento" 5 "5 3 7" 3 "+oo" "o*o" "ooo"


    # reinizializzazione a meno elementi dopo caricamento
    esegui_test "reinizializzazione a meno elementi dopo caricamento" 5 "5 3 1 2 2 1 1 0 3 7" 2 "oo" "-o"

    # "reinizializzazione a zero elementi dopo caricamento"
    esegui_test "reinizializzazione a zero elementi dopo caricamento" 5 "5 1 0 3 7" 0

    esegui_test "reinizializzazione a stesso numero di elementi dopo caricamento" 5 "5 1 3 3 7" 3 "ooo" "ooo" "ooo"

    # caricamento dopo reinizializzazione
    esegui_test "caricamento dopo reinizializzazione" 5 "1 2 2 1 1 0 5 3 7" 3 "+oo" "o*o" "ooo"


    esegui_test "cerca riga 1" 6 "5 3 6 7" 1 0

    esegui_test "cerca riga 2" 6 "5 2 1 1 0 3 6 7" 1 1
    ...
    # esegui_test "tentativo di scambio con una parola fuori matrice" 5 "4 5 0 0 3 0 5 0 0 3 10 3 7" 3 "Paperino" "Minnie" "Pippo Quo"
