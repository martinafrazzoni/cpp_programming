...
esegui_tutti_test ()
{
    ...
    esegui_test "stampa senza reinizializzazione" "" "2 8" 0

    # "reinizializzazione non corretta a vuoto, senza stampa"

    # reinizializzazione senza stampa
    esegui_test "reinizializzazione a un elemento, senza stampa" "" "1 1 paolo 8" 0

    esegui_test "reinizializzazione a un elemento, con stampa" "" "1 1 paolo 2 8" 2 "LMMGVSD" "------- paolo"

    # reinizializzazione a molti elementi
    esegui_test "reinizializzazione a molti elementi" "" "1 3 paolo rita sonia 2 8" 4 "LMMGVSD" "------- paolo" "------- rita" "------- sonia"
    ...
    esegui_test "doppia reinizializzazione con seconda a vuoto" "" "1 3 paolo rita sonia 2 1 0 8" 0

    # doppia reinizializzazione con seconda a un elemento
    esegui_test "doppia reinizializzazione con seconda a un elemento" "" "1 3 paolo rita sonia 2 1 1 pippo 2 8" 2 "LMMGVSD" "------- pippo"

    # doppia reinizializzazione con seconda a stesso numero di elementi
    esegui_test "doppia reinizializzazione con seconda a stesso numero di elementi" "" "1 3 paolo rita sonia 2 1 3 pippo pluto paperino 2 8" 4 "LMMGVSD" "------- pippo" "------- pluto" "------- paperino"

    # doppia reinizializzazione con prima a vuoto e seconda a molti elementi
    esegui_test "doppia reinizializzazione con prima a vuoto e seconda a molti elementi" "" "1 0 1 3 paolo rita sonia 2 8" 4 "LMMGVSD" "------- paolo" "------- rita" "------- sonia"
    ...
    esegui_test "ricerca di elemento presente" 3 "1 3 paolo rita sonia 3 rita 8" 1 "1"

    esegui_test "ricerca di elemento presente al primo posto" 3 "1 3 paolo rita sonia 3 paolo 8" 1 "0"

    esegui_test "ricerca di elemento presente alll'ultimo posto" 3 "1 3 paolo rita sonia 3 sonia 8" 1 "2"

    # ricerca di elemento non presente
    esegui_test "ricerca di elemento non presente" 3 "1 3 paolo rita sonia 3 soniaa 8" 1 "-1"

    esegui_test "ricerca di elemento in elenco vuoto" 3 "3 soniaa 8" 1 "-1"

    esegui_test "ricerca di elemento in elenco reinizializzato a vuoto" 3 "1 0 3 soniaa 8" 1 "-1"

    # inserimento di un oggetto
    esegui_test "aggiornamento di un oggetto" 4 "1 3 paolo rita sonia 4 rita -*-*--* 2 8" 4 "LMMGVSD" "------- paolo" "-*-*--* rita" "------- sonia"

    esegui_test "aggiornamento di un oggetto in elenco vuoto" 4 "4 rita -*-*--* 8" 0

    # "inserimento un elemento con stampa"
    # inserimento di due oggetti
    esegui_test "aggiornamento di due oggetti" 4 "1 3 paolo rita sonia 4 rita -*-*--* 4 paolo *-----* 2 8" 4 "LMMGVSD" "*-----* paolo" "-*-*--* rita" "------- sonia"

    esegui_test "aggiornamento di un oggetto con una stringa troppo lunga" 4 "1 3 paolo rita sonia 4 rita -*-*--* 4 paolo *-----*- 2 8" 0

    esegui_test "aggiornamento di un oggetto non presente" 4 "1 3 paolo rita sonia 4 rita -*-*--* 4 paola *-----* 2 8" 0
    ...
    #Â inserimento di un oggetto sovrapposto
    ...
    esegui_test "salvataggio" 5 "1 3 paolo rita sonia 4 rita -*-*--* 4 paolo *-----* 4 sonia --*--** 5 2 8" 4 "LMMGVSD" "*-----* paolo" "-*-*--* rita" "--*--** sonia"

    # "salvataggio e aggiunta di un elemento"
    esegui_test "salvataggio e aggiornamento di un elemento" 5 "1 3 paolo rita sonia 4 rita -*-*--* 4 paolo *-----* 5 4 sonia --*--** 2 8" 4 "LMMGVSD" "*-----* paolo" "-*-*--* rita" "--*--** sonia"

    # "salvataggio, aggiunta di un elemento e nuovo salvataggio"

    esegui_test "salvataggio, aggiornamento di un elemento e nuovo salvataggio" 5 "1 3 paolo rita sonia 4 rita -*-*--* 4 paolo *-----* 5 4 sonia --*--** 5 2 8" 4 "LMMGVSD" "*-----* paolo" "-*-*--* rita" "--*--** sonia"

    # "salvataggio e reinizializzazione a stesso numero di elementi"
    esegui_test "salvataggio" 5 "1 3 paolo rita sonia 4 rita -*-*--* 4 paolo *-----* 4 sonia --*--** 5 1 3 pippo pluto paperino 2 8" 4 "LMMGVSD" "------- pippo" "------- pluto" "------- paperino"

    # "caricamento"

    esegui_test "preparazione caricamento elenco vuoto" 6 "5 2 8" 0
    esegui_test "caricamento elenco vuoto" 6 "6 8" 0

    esegui_test "salvataggio per preparazione prossimi test" 6 "1 3 paolo rita sonia 4 rita -*-*--* 4 paolo *-----* 4 sonia --*--** 5 2 8" 4 "LMMGVSD" "*-----* paolo" "-*-*--* rita" "--*--** sonia"

    esegui_test "caricamento" 6 "6 2 8" 4 "LMMGVSD" "*-----* paolo" "-*-*--* rita" "--*--** sonia"

    # reinizializzazione a meno elementi dopo caricamento
    esegui_test "reinizializzazione a meno elementi dopo caricamento" 6 "6 1 2 paola pluto 2 8" 2 "LMMGVSD" "------- paola" "------- pluto"

    # "reinizializzazione a zero elementi dopo caricamento"
    esegui_test "reinizializzazione a zero elementi dopo caricamento" 6 "6 1 0 2 8" 0

    esegui_test "reinizializzazione a stesso numero di elementi dopo caricamento" 6 "6 1 3 primo secondo terzo 2 8" 4 "LMMGVSD" "------- primo" "------- secondo" "------- terzo"

    # caricamento dopo reinizializzazione
    esegui_test "caricamento dopo reinizializzazione" 6 "1 2 primo secondo 6 2 8" 4 "LMMGVSD" "*-----* paolo" "-*-*--* rita" "--*--** sonia"


    esegui_test "minimizza turni" 7 "6 7 2 8" 4 "LMMGVSD" "*-----* paolo" "-*-*--- rita" "--*--*- sonia"

    esegui_test "minimizza turni su elenco vuoto" 7 "7 8" 0

    esegui_test "minimizza turni senza cambiamenti" 7 "1 2 paolo sonia 4 paolo *-----* 7 2 8" 3 "LMMGVSD" "*-----* paolo" "------- sonia"
    ...
    # esegui_test "tentativo di scambio con una parola fuori matrice" 5 "4 5 0 0 2 0 5 0 0 2 10 2 8" 3 "Paperino" "Minnie" "Pippo Quo"
