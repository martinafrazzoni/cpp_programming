...
esegui_tutti_test ()
{
    ...
    esegui_test "stampa senza inserimento" "" "3 7" 0

    # reinizializzazione a vuoto senza stampa
    esegui_test "reinizializzazione non corretta a vuoto, senza stampa" "" "1 0 7" 0

    # reinizializzazione senza stampa
    esegui_test "reinizializzazione a un codice, senza stampa" "" "1 1 7" 0

    esegui_test "reinizializzazione a un codice, con stampa" "" "1 1 3 7" 0

    esegui_test "inserimento di un elemento" "" "2 1 3 7" 1 "1 1"

    # reinizializzazione
    # "inserimento un elemento con stampa"

    # reinizializzazione a molti elementi
    esegui_test "reinizializzazione a molti codici, con stampa" "" "1 100 3 7" 0

    esegui_test "inserimento di molti elementi" "" "1 100 2 1 2 2 2 1 2 3 2 4 3 7" 4 "1 2" "2 1" "3 1" "4 1"
    ...
    esegui_test "inserimento di un codice troppo grande" "" "1 5 2 1 2 1 2 5 2 5 3 7" 2 "1 2" "5 2"
    ...
    esegui_test "inserimento di un codice troppo grande" "" "1 5 2 1 2 1 2 6 2 5 3 7" 2 "1 2" "5 1"

    esegui_test "inserimento di un codice troppo piccolo" "" "1 5 2 1 2 1 2 0 2 5 3 7" 2 "1 2" "5 1"
    ...
    # "salvataggio"
    esegui_test "salvataggio" 4 "1 100 2 3 2 3 2 3 2 3 2 3 2 16 2 16 2 16 2 20 2 20 2 20 2 20 4 3 7" 3 "3 5" "16 3" "20 4"

    # "salvataggio e aggiunta di un elemento"
    esegui_test "salvataggio e aggiunta di elementi" 4 "1 100 2 3 2 3 2 3 2 3 2 3 2 16 2 16 2 16 2 20 2 20 2 20 2 20 4 2 3 2 4 3 7" 4 "3 6" "4 1" "16 3" "20 4"

    esegui_test "salvataggio e aggiunta di elementi, e nuovo salvataggio" 4 "1 100 2 3 2 3 2 3 2 3 2 3 2 16 2 16 2 16 2 20 2 20 2 20 2 20 4 2 3 2 4 4 3 7" 4 "3 6" "4 1" "16 3" "20 4"

    # "salvataggio, aggiunta di un elemento e nuovo salvataggio"

    # "salvataggio e reinizializzazione"

    esegui_test "salvataggio e reinizializzazione" 4 "1 100 2 3 2 3 2 3 2 3 2 3 2 16 2 16 2 16 2 20 2 20 2 20 2 20 4 1 1 2 1 3 7" 1 "1 1"
    esegui_test "salvataggio, reinizializzazione e aggiunta di elementi" 4 "1 100 2 3 2 3 2 3 2 3 2 3 2 16 2 16 2 16 2 20 2 20 2 20 2 20 4 1 4 2 3 2 4 3 7" 2 "3 1" "4 1"

    # "caricamento"
    esegui_test "caricamento archivio vuoto" 5 "4 5 2 1 3 7" 1 "1 1"

    esegui_test "nuovo salvataggio solo per preparare prossimo test" 5 "1 100 2 3 2 3 2 3 2 3 2 3 2 16 2 16 2 16 2 20 2 20 2 20 2 20 4 3 7" 3 "3 5" "16 3" "20 4"

    esegui_test "caricamento" 5 "5 3 7" 3 "3 5" "16 3" "20 4"

    esegui_test "reinizializzazione, aggiunta, salvataggio e caricamento" 5 "1 100 2 3 2 3 2 3 2 3 2 3 2 16 2 16 2 16 2 20 2 20 2 20 2 20 4 2 3 2 4 5 3 7" 3 "3 5" "16 3" "20 4"

    # reinizializzazione a meno elementi dopo caricamento
    esegui_test "reinizializzazione a meno elementi dopo caricamento" 5 "5 1 2 2 2 2 2 3 7" 1 "2 2"

    # "reinizializzazione a zero elementi dopo caricamento"

    # caricamento dopo reinizializzazione

    esegui_test "caricamento dopo inserimento di due oggetti" 5 "1 2 2 1 2 2 5 3 7" 3 "3 5" "16 3" "20 4"

    esegui_test "inserimento di due oggetti dopo caricamento" 5 "5 2 3 2 4 3 7" 4 "3 6" "4 1" "16 3" "20 4"
    ...
    esegui_test "elimina elemento da insieme vuoto" 6 "6 7" 1 "0"

    esegui_test "elimina elemento da insieme con un elemento" 6 "2 1 6 7" 1 "1"

    esegui_test "elimina due elementi da insieme con un elemento" 6 "2 1 6 6 7" 1 "0"

    esegui_test "elimina un elemento da insieme con piu' elementi" 6 "5 6 3 7" 2 "16 3" "20 4"

    esegui_test "elimina due elementi da insieme con piu' elementi" 6 "5 6 6 3 7" 1 "20 4"
