...
esegui_tutti_test ()
{
    ...
    esegui_test "reinizializzazione a dimensione uno, senza stampa" "" "1 1 v 7" 0

    # "reinizializzazione a dimensione uno, con stampa" ""

    # reinizializzazione a molti elementi

    esegui_test "reinizializzazione a dimensione maggiore di uno, senza stampa" "" "1 2 v ^ 7" 0
    ...
    esegui_test "doppia reinizializzazione con seconda a vuoto" "" "1 3 v v < 1 0 7" 0

    # doppia reinizializzazione con seconda a un elemento
    esegui_test "doppia reinizializzazione con seconda a un elemento" "" "1 3 v v v 1 1 < 7" 0
    ...
    esegui_test "reinizializzazione a un elemento con stampa" "" "1 3 v v v 1 1 ^ 2 7" 1 "^"


    # reinizializzazione a piu' elementi con stampa
    esegui_test "reinizializzazione a piu' elementi con stampa" "" "1 3 v < > 2 7" 1 "v < >"
    ...
    esegui_test "reinizializzazione con elemento non valido" "" "1 3 v < > 1 1 * 2 7" 1 "v < >"


    esegui_test "reinizializzazione con sequenza contenente ultimo elemento non valido" "" "1 3 v < > 1 2 ^ * 2 7" 1 "v < >"

    esegui_test "reinizializzazione con sequenza contenente primo elemento non valido" "" "1 3 v < > 1 2 * ^ 2 7" 1 "v < >"
    ...
    esegui_test "reinizializzazione con elemento non valido prima e poi valido" "" "1 1 ^ 1 3 v < > 2 7" 1 "v < >"
    ...
    # "salvataggio"
    esegui_test "salvataggio" 3 "1 4 v ^ > > 3 2 7" 1 "v ^ > >"

    # "salvataggio e aggiunta di un elemento"

    # "salvataggio e reinizializzazione a stesso numero di elementi"
    esegui_test "salvataggio e reinizializzazione a stessa lunghezza" 3 "1 4 v ^ > > 3 1 4 < < < < 2 7" 1 "< < < <"

    # "salvataggio, aggiunta di un elemento e nuovo salvataggio"

    # "caricamento"
    esegui_test "caricamento" 4 "4 2 7" 1 "v ^ > >"
    ...
    esegui_test "salvataggio per preparazione prossimi test" 4 "1 4 v ^ > > 3 2 7" 1 "v ^ > >"

    # reinizializzazione a meno elementi dopo caricamento
    esegui_test "reinizializzazione a meno elementi dopo caricamento" 4 "4 1 2 < < 2 7" 1 "< <"
    ...
    esegui_test "reinizializzazione a stesso numero di elementi dopo caricamento" 4 "4 1 4 < < < < 2 7" 1 "< < < <"

    # caricamento dopo reinizializzazione
    esegui_test "caricamento dopo reinizializzazione" 4 "1 2 < < 4 2 7" 1 "v ^ > >"


    esegui_test "stampa sequenza 2" 5 "4 5 7" 2 "v ^ > >" "(1 0) (0 0) (0 1) (0 2)"

    esegui_test "stampa sequenza 2 con solo destra e sinistra" 5 "1 2 > < 5 7" 2 "> <" "(0 1) (0 0)"

    esegui_test "stampa sequenza 2 con un solo spostamento" 5 "1 1 > 5 7" 2 ">" "(0 1)"

    esegui_test "stampa traccia" 6 "4 6 7" 2 "* * *" "* - -"

    esegui_test "stampa traccia orizzontale" 6 "1 1 > 5 6 7" 1 "* *"

    esegui_test "stampa traccia verticale" 6 "1 1 v 5 6 7" 2 "*" "*"

    esegui_test "stampa traccia simmetrica" 6 "1 4 v ^ > < 5 6 7" 2 "* *" "* -"

    esegui_test "stampa traccia quadrata" 6 "1 6 v ^ > v ^ < 5 6 7" 2 "* *" "* *"

    return

    # intersezione con sovrainsieme
    esegui_test "intersezione con sovrainsieme" 6 "1 5 2 2 2 5 6 3 5 2 4 3 7" 1 "2 5"

    esegui_test "intersezione non vuota" 6 "1 5 2 2 2 5 6 3 3 2 4 3 7" 1 "2"

    esegui_test "intersezione con insieme vuoto" 6 "1 5 2 2 2 5 6 0 2 1 3 3 7" 1 "3"

    esegui_test "intersezione vuota" 6 "1 5 2 2 2 5 6 3 1 3 4 2 1 3 3 7" 1 "3"


    esegui_test "stampa sequenza massima in mezo indietro" 6 "1 13 2 8 1 3 4 7 9 10 11 13 7 7" 1 "9 10 11"

    esegui_test "stampa sequenza massima in mezzo davanti" 6 "1 14 2 9 2 4 5 6 7 10 12 13 14 7 7" 1 "4 5 6 7"

    esegui_test "stampa sequenza massima in fondo" 6 "1 13 2 7 1 3 4 7 9 10 11 7 7" 1 "9 10 11"

    esegui_test "stampa sequenza massima in testa" 6 "1 14 2 8 4 5 6 7 10 12 13 14 7 7" 1 "4 5 6 7"
