...
esegui_tutti_test ()
{
    ...
    esegui_test "reinizializzazione a un elemento con stampa" "" "1 1 .|.|.|.|.|.|.|.| 2 7"  2 "0 1 2 3 4 5 6 7"  ".|.|.|.|.|.|.|.|"
    ...
    esegui_test "doppia reinizializzazione con seconda a vuoto, senza stampa" "" "1 2 .|.|.|.|.|.|.|.| .|.|.|.|.|.|.|| 1 0 7" 0

    # doppia reinizializzazione con seconda a un elemento
    esegui_test "doppia reinizializzazione con seconda a un elemento" "" "1 2 .|.|.|.|.|.|.|.| .|.|.|.|.|.|.|| 1 1 .|.|.|.|.|.|.|.|  2 7" 2 "0 1 2 3 4 5 6 7" ".|.|.|.|.|.|.|.|"

    # doppia reinizializzazione con seconda a stesso numero di elementi
    esegui_test "doppia reinizializzazione con seconda a un elemento" "" "1 2 .|.|.|.|.|.|.|.| .|.|.|.|.|.|.|| 1 2 .|.|.|.|.|.|.|.| .|.|.|.|.|.|.|.| 2 7" 2 "0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7" ".|.|.|.|.|.|.|.| .|.|.|.|.|.|.|.|"
    ...
    esegui_test "reinizializzazione a piu' elementi con stampa" "" "1 3 .||.|..|.|.||..| .|.|.|.|.|.|.|.| |.|.|.|..|.|.|.| 2 7" 2 "0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7" ".||.|..|.|.||..| .|.|.|.|.|.|.|.| |.|.|.|..|.|.|.|"

    # inizializzazione con carattere non valido, senza stampa
    esegui_test "inizializzazione con carattere non valido, senza stampa" "" "1 1 .|.|.|.|.|.|.X.| 7" 0

    # reinizializzazione con carattere non valido
    esegui_test "reinizializzazione con carattere non valido" "" "1 2 .|.|.|.||.|.|.|. .|.|.|.|.|.|.|.| 1 1 .|.|.|.|.|.|.|.P 2 7" 2 "0 1 2 3 4 5 6 7" "|.|.|.|.|.|.|.|."

    # reinizializzazione a piu' elementi con carattere non valido
    esegui_test "reinizializzazione a piu' elementi con carattere non valido" "" "1 2 .|.|.|.||.|.|.|. x|.|.|.|.|.|.|.| 2 7" 2 "0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7" ".|.|.|.||.|.|.|. |.|.|.|.|.|.|.|."

    # reinizializzazione con stringhe di lunghezza diversa
    esegui_test "reinizializzazione con stringhe di lunghezza sbagliata" "" "1 2 .|.|.|.|.|.|.|. .|.|.|.|.|.|.|.| 2 7" 2 "0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7" "|.|.|.|.|.|.|.|. .|.|.|.|.|.|.|.|"
    ...
    # "salvataggio"
    esegui_test "salvataggio" 3 "1 2 .|.|.|.|.|.|.|.| .|.|.|.||.|.|.|. 3 2 7" 2 "0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7"  ".|.|.|.|.|.|.|.| .|.|.|.||.|.|.|."


    # "salvataggio e aggiunta di un elemento"

    # "salvataggio e reinizializzazione a stesso numero di elementi"
    esegui_test "salvataggio e reinizializzazione a stessa lunghezza" 3 "1 2 .|.|.|.|.|.|.|.| .|.|.|.||.|.|.|. 3 1 2 .||..||..||..|.| .|.|.|.|.|.|.|.| 2 7" 2 "0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7"  ".||..||..||..|.| .|.|.|.|.|.|.|.|"

    # "salvataggio, aggiunta di un elemento e nuovo salvataggio"

    # "caricamento"
    esegui_test "caricamento" 4 "4 2 7" 2 "0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7"  ".|.|.|.|.|.|.|.| .|.|.|.||.|.|.|."
    ...
    esegui_test "reinizializzazione a meno elementi dopo caricamento" 4 "4 1 1 |.|.|.|..|.|.|.| 2 7" 2 "0 1 2 3 4 5 6 7" "|.|.|.|..|.|.|.|"
    ...
    esegui_test "reinizializzazione a stesso numero di elementi dopo caricamento" 4 "4 1 2 .||..|.|.|.|.|.| .|.|.|.||.|.|..| 2 7" 2 "0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7"  ".||..|.|.|.|.|.| .|.|.|.||.|.|..|"

    # caricamento dopo reinizializzazione
    esegui_test "caricamento dopo reinizializzazione" 4 "1 2 .||..|.|.|.|.|.| .|.|.|.||.|.|..| 4 2 7" 2 "0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7"  ".|.|.|.|.|.|.|.| .|.|.|.||.|.|.|."

    esegui_test "reinizializza etichetta con valore 0" 5 "5 1 0 2 7" 2 "0 1 2 3 4 5 6 7"  "|.|.|.|.|.|.|.|."

    esegui_test "reinizializza etichetta con valore 1" 5 "5 1 1 2 7" 2 "0 1 2 3 4 5 6 7"  "|.|.|.|.|.|.|..|"

    esegui_test "reinizializza etichetta con valore 2" 5 "5 1 2 2 7" 2 "0 1 2 3 4 5 6 7"  "|.|.|.|.|.|..||."

    esegui_test "reinizializza etichetta con valore 255" 5 "5 1 255 2 7" 2 "0 1 2 3 4 5 6 7"  ".|.|.|.|.|.|.|.|"

    esegui_test "reinizializza etichetta con valore 254" 5 "5 1 254 2 7" 2 "0 1 2 3 4 5 6 7"  ".|.|.|.|.|.|.||."


    esegui_test "stampa etichetta con valore 0" 5 "5 1 0 6 7" 1 "0"

    esegui_test "stampa etichetta con valore 1" 5 "5 1 1 6 7" 1 "1"

    esegui_test "stampa etichetta con valore 2" 5 "5 1 2 6 7" 1 "2"

    esegui_test "stampa etichetta con valore 255" 5 "5 1 255 6 7" 1 "255"

    esegui_test "stampa etichetta con valore 254" 5 "5 1 254 6 7" 1 "254"
